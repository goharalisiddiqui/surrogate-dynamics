...
set -e
# Activate space env
spack env activate md_skylake_avx512
#############################################
...
gmx_mpi mdrun -s em.tpr -deffnm em &> out_2-4.txt
...
gmx_mpi mdrun -s nvt.tpr -deffnm nvt &> out_3-2.text
...
echo "Step 02 - Equilibration"
gmx_mpi mdrun -s npt.tpr -deffnm npt &> out_4-2.text
